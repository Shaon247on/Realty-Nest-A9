            ...
            <SwiperSlide>
                <div className='flex flex-col gap-6 group md:left-[0px] relative mr-16 shadow-lg text-white p-6 h-[650px] md:h-[600px] w-full overflow-hidden'>
                    ...
                    <div className='relative top-24 space-y-5 px-6 lg:pl-28'>
                        <h2 className='text-white text-3xl md:text-6xl font-open'>Single Family House</h2>
                        ...
                        <div>
                            <p className='text-2xl font-semibold font'><span className='font-bold font-open'>Area:</span> 1800 sq ft</p>
                        ...
                        <Link className="btn bg-gradient-to-t from-[#8E793E] to-[#AD974F] border-0 hover:bg-gradient-to-t hover:from-[#725f3a] hover:to-[#ac9b65] text-white" to='/6'><button >View Details</button></Link>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='flex flex-col gap-6 group md:left-[0px] relative mr-16 shadow-lg text-white p-6 h-[650px] md:h-[600px] w-full'>
                    ...
                    <div className='absolute inset-0 bg-black opacity-60 ' />
                    <div className='relative top-24 space-y-5 px-6 lg:pl-28'>
                        <h2 className='text-white text-3xl md:text-6xl font-open'>Vacation Rentals</h2>
                        ...
                        <div>
                            <p className='text-2xl font-semibold font'><span className='font-bold font-open'>Area:</span> 3000 sq ft</p>
                            <div className='flex gap-4 mt-4 text-2xl'>
                                <div className='flex gap-2 items-center bg-slate-400/15 rounded-2xl px-3 py-1'>
                                    <IoBedOutline></IoBedOutline>
                                    <p>4</p>
                        ...
                        <Link className="btn bg-gradient-to-t from-[#8E793E] to-[#AD974F] border-0 hover:bg-gradient-to-t hover:from-[#725f3a] hover:to-[#ac9b65] text-white" to='/2'><button >View Details</button></Link>
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='flex flex-col gap-6 group md:left-[0px] relative mr-16 shadow-lg text-white p-6 h-[650px] md:h-[600px] w-full overflow-hidden '>
                    ...
                    <div className='absolute inset-0 bg-black opacity-60 ' />
                    <div className='relative top-24 space-y-5 px-6 lg:pl-28'>
                        <h2 className='text-white text-3xl md:text-6xl font-open'>Apartment</h2>
                        ...
                        <div>
                            <p className='text-2xl font-semibold font'><span className='font-bold font-open'>Area:</span> 900 sq ft</p>
                            <div className='flex gap-4 mt-4 text-2xl'>
                                <div className='flex gap-2 items-center bg-slate-400/15 rounded-2xl px-3 py-1'>
                                    <IoBedOutline></IoBedOutline>
                                    <p>2</p>
                        ...
                        <Link className="btn bg-gradient-to-t from-[#8E793E] to-[#AD974F] border-0 hover:bg-gradient-to-t hover:from-[#725f3a] hover:to-[#ac9b65] text-white" to='/4'><button >View Details</button></Link>
                    </div>
                </div>
            </SwiperSlide>
        </Swiper>
